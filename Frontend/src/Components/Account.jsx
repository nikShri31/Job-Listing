...
const Account = () => {
  ...
  return (
    ...
    >
      <Grid item xs={12} minWidth={300}  md={3} sx={{border:'3px solid red', my:-3}}>
       ...
       <Grid item xs={12}  md={6}  sx={{ backgroundColor:'#FFF',my:3, px:2}}>
        <Box>
          <Typography  variant="h4" sx={{my:3}}>Account Setting</Typography>
          <Stack>
            <Accordion>
              <AccordionSummary
      ...
      >
        ...
        <FormControlLabel value="employer" control={<Radio />} label="Employer" />
            ...
            >
              <TextField fullWidth label="Enter new email address" id="changeEmail" />
            </Box>
              </AccordionDetails>
              <AccordionActions>
                <Button>Cancel</Button>
                  ...
                  startAdornment: (
                    <InputAdornment position="start">
                      ...
                      <TextField
                        ...
                        variant="standard"
                        sx={{ width: "80px", marginLeft: "8px", py:2 }}
                      >
