...
import { setUserSelectedJobView, clearUserSelectedJobView } from '../../../store/appliedJobsSlice';
              ...
              <Stack direction={'row'} justifyContent="space-between" sx={{ width: '95%' }}>
                <Box>
                  ...
                  <Stack direction={'row'} spacing={1} py={1}>
                    <BusinessIcon />
                    <Typography variant="h6">{job.organisation?.name}</Typography>
                  </Stack>
                ...
                {/** 3 dot Menu */}
                <Box>
                  <ThreeDotMenu handleViewDetails={handleViewDetails} job={job} />
                </Box>
              </Stack>
            </Container>
